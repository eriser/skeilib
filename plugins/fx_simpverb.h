...
: public SPlugin
{
  ...
  public:
    ...
    void on_create(void) {
      ...
      MInfo.numInputs  = 2;
      MInfo.numOutputs = 2;
      appendParameter( new SParamFloat( "Size",     50,  0,   100, 1 ));
      appendParameter( new SParamFloat( "Damping",  80,  0,   100, 1 ));
      appendParameter( new SParamFloat( "Dry",     -6,  -120, 0 ));
      appendParameter( new SParamFloat( "Wet",     -6,  -120, 0 ));
  ...
  public:
    ...
    */
    ...
    void on_parameterChange(int32 AIndex, float AValue) {
      ...
      roomSize          = 10 + slider1 / 100 * 90;
      damp              = SMin(1-slider2/100,0.9);
      ring              = 0.5;
      dry               = pow(2,slider3/6);
      wet               = pow(2,slider4/6);
      comb1             = 0;
      comb1Pos          = 0;
      comb1Length       = floor(1 * roomSize * MState.sampleRate /1000);
      comb2             = comb1Length;
      comb2Pos          = 0;
      comb2Length       = floor(1.1 * roomSize * MState.sampleRate /1000);
      comb3             = comb2Length + comb1Length;
      comb3Pos          = 0;
      comb3Length       = floor(1.3 * roomSize * MState.sampleRate /1000);
      allpassL1         = comb3Length + comb2Length + comb1Length;
      allpassL1Pos      = 0;
      allpassL1Length   = floor(2 * MState.sampleRate /1000);
      allpassR1         = allpassL1Length + allpassL1Start + comb3Length + comb2Length + comb1Length;
      allpassR1Pos      = 0;
      allpassR1Length   = floor(2.5 * MState.sampleRate /1000);
      comb4             = allpassR1Length + allpassL1Length + allpassL1Start + comb3Length + comb2Length + comb1Length;
      comb4Pos          = 0;
      comb4Length       = floor(1.5 * roomSize * MState.sampleRate /1000);
      allpassL2         = comb4 + allpassR1Length + allpassL1Length + allpassL1Start + comb3Length + comb2Length + comb1Length;
      allpassL2Length   = floor(1 * MState.sampleRate /1000);
      allpassR2         = allpassL2Length + comb4 + allpassR1Length + allpassL1Length + allpassL1Start + comb3Length + comb2Length + comb1Length;
      allpassR2Length   = floor(1.5 * MState.sampleRate /1000);
    }
