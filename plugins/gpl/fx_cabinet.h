...
: public SPlugin
{
  ...
  public:
    ...
    //virtual
    void on_create(void) {
      MInfo.name       = "fx_cabinet";
      MInfo.author     = "skeilib";
      MInfo.product    = MInfo.name;
      MInfo.uniqueId   = SKEI_MAGIC + 0x0000;
      MInfo.numInputs  = 2;
      MInfo.numOutputs = 2;
      appendParameter( new SParameter("gain", 1) );
      appendParameter( new SParamText("mode", 0, 2, txt_mode ) );
      gain = 1;
      mode = 0;
    }
  ...
  public:
    ...
    void on_processBlock(SSample** AInputs, SSample** AOutputs, int32 ANumSamples) {
      SSample* in0  = AInputs[0];
      SSample* in1  = AInputs[1];
      SSample* out0 = AOutputs[0];
      SSample* out1 = AOutputs[1];
