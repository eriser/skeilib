...
char* do_zenity(void) {
  ...
  fgets(zenity_filename,1024,f);
  return zenity_filename;
}

//----------

char* SDialog_ColorSelect(const char* ATitle, bool APalette=true) {
...
char* SDialog_Error(const char* ATitle, const char* AText) {
  SStrcpy(zenity_buffer,"zenity --error");
  SStrcat(zenity_buffer," --text='");    SStrcat(zenity_buffer,AText);    SStrcat(zenity_buffer,"'");
  return do_zenity();
}

char* SDialog_FileOpen(const char* ATitle, bool AMultiple=false) {
...
char* SDialog_FileSave(const char* ATitle, const char* AFilename) {
  SStrcpy(zenity_buffer,"zenity --file-selection");
...
char* SDialog_Info(const char* ATitle, const char* AText) {
  SStrcpy(zenity_buffer,"zenity --info");
  SStrcat(zenity_buffer," --text='");    SStrcat(zenity_buffer,AText);    SStrcat(zenity_buffer,"'");
  return do_zenity();
}

char* SDialog_Question(const char* ATitle, const char* AText) {
  SStrcpy(zenity_buffer,"zenity --question");
  SStrcat(zenity_buffer," --text='");    SStrcat(zenity_buffer,AText);    SStrcat(zenity_buffer,"'");
  return do_zenity();
}

char* SDialog_Text(const char* ATitle, const char* AText, const char* AEntryText) {
...
char* SDialog_TextInfo(const char* ATitle, const char* AFilename, bool AEditable=false, bool AHtml=false, const char* AUrl=SKEI_NULL) {
...
char* SDialog_Value(const char* ATitle, const char* AText, int AVal=0, int AMin=0, int AMax=100, int AStep=1) {
  char temp[256];
...
char* SDialog_Warning(const char* ATitle, const char* AText) {
