#ifndef skei_lpc_included
#define skei_lpc_included
//----------------------------------------------------------------------
...
void SAutoCorrelate(float* x, float* R, int32 P, float lambda, int32 l=-1) {
//var
//  dl,Rt     : TDoubleArray;
//  r1,r2,r1t : Double;
//  k,i       : Integer;
...
void KLevinsonRecursion(P:Integer; R,A,K:TSingleArray) {
var
  Am1       : TDoubleArray;
  i,j,s,m   : Integer;
  km,Em1,Em : Double;
