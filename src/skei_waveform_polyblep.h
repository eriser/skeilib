#ifndef skei_waveform_polyblep
#define skei_waveform_polyblep
//----------------------------------------------------------------------
...
class SWaveform_Tri_PolyBlep {
  private:
    SWaveform_Squ_PolyBlep squ;
    float x1;
  public:
    SWaveform_Tri_PolyBlep() {
      x1 = 0;
    }
    float process(float t, float dt) {
