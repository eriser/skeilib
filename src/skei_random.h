#ifndef skei_random_included
#define skei_random_included
//----------------------------------------------------------------------
...
//static KRandom_Rand KODE_RANDOM;
//inline float SRandom(void) { return SKEI_RANDOM.random(); }
//inline float SRandomSigned(void) { return SKEI_RANDOM.randomSigned(); }
...
int32 SRandomRangeInt(int32 minval, int32 maxval) {
  ...
  //else return minval + SModulo(SRandomInt(),range);
  else return minval + ( SRandomInt() % range );
}
