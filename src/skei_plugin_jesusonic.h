#ifndef skei_plugin_jesusonic_included
#define skei_plugin_jesusonic_included
//----------------------------------------------------------------------

/*
  simplify jesusonic -> vst conversion
*/
