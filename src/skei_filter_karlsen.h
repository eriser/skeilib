#ifndef skei_filter_karlsen_included
#define skei_filter_karlsen_included
//----------------------------------------------------------------------
  ...
  public:
    ...
    void process(float AValue/*, float* L, float* B, float* N, float* H*/) {
      for (int32 o=0; o<fOS; o++) {
        ...
        fPole[1] = (((AValue + /*sDenorm*/ SKEI_FLT_DENORM )-intfp) * fF1) + (fPole[1] * (1 - fF1));
