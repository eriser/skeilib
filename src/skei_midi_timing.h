#ifndef skei_midi_timing_included
#define skei_midi_timing_included
//----------------------------------------------------------------------
...
#define SKEI_MIDI_TIMING_MAX_EVENTS 256
...
class SMidiTiming {
  private:
    ...
    uint32    MNextEvent;
    uint32    MNumEvents;
    SMTEvent  MEvents[SKEI_MIDI_TIMING_MAX_EVENTS];
    SMidiTiming_Listener* MListener;
  ...
  public:
    ...
    void event( uint32 ofs, uint8 msg1, uint8 msg2, uint8 msg3) {
      if (MNumEvents<SKEI_MIDI_TIMING_MAX_EVENTS) {
