#ifndef skei_filter_hiir_included
#define skei_filter_hiir_included
//----------------------------------------------------------------------
...
class SFilter_Hiir12_Steep {
  private:
    float FPrevious;
    SFilter_Allpass a0,a1,a2,a3,a4,a5;
    SFilter_Allpass b0,b1,b2,b3,b4,b5;
  public:
    SFilter_Hiir12_Steep() {
      FPrevious = 0;
...
class SFilter_Hiir10_Steep {
  private:
    float FPrevious;
    SFilter_Allpass a0,a1,a2,a3,a4;
    SFilter_Allpass b0,b1,b2,b3,b4;
  public:
    SFilter_Hiir10_Steep() {
      FPrevious = 0;
...
class SFilter_Hiir8_Steep {
  private:
    float FPrevious;
    SFilter_Allpass a0,a1,a2,a3;
    SFilter_Allpass b0,b1,b2,b3;
  public:
    SFilter_Hiir8_Steep() {
      FPrevious = 0;
...
class SFilter_Hiir4_Steep {
  private:
    float FPrevious;
    SFilter_Allpass a0,a1;
    SFilter_Allpass b0,b1;
  public:
    SFilter_Hiir4_Steep() {
      FPrevious = 0;
