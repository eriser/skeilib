#ifndef skei_filter_onepole_included
#define skei_filter_onepole_included
//----------------------------------------------------------------------
    ...
    float process(float AInput) {
      ...
      switch (FType) {
        case 0: // no filter
          ...
          break;
        case 1: // lp
          y = (i_a0 * AInput) + (i_b1*y) + SKEI_FLT_DENORM;
          return (y - SKEI_FLT_DENORM) * _gain;
          break;
        case 2: // hp
          y = (i_a0 * AInput) + (i_b1*y) + SKEI_FLT_DENORM;
          return (AInput - y - SKEI_FLT_DENORM) * _gain;
          break;
        case 3: // ls
          y = (i_a0*AInput) + (i_b1*y) + SKEI_FLT_DENORM;
          return AInput + ((y - SKEI_FLT_DENORM) * _gain2);
          break;
        case 4: // hs
          y = (i_a0*AInput) + (i_b1*y) + SKEI_FLT_DENORM;
          return AInput + ((AInput - y - SKEI_FLT_DENORM) * _gain2);
          break;
      }
    }
