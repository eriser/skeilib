...
procedure KReaperExt.initialize(AMaster:TAudioMasterCallbackFunc);
begin
  FMaster := AMaster;
...
function KReaperExt.getPlayPosition : double;
begin
...
function KReaperExt.getPlayPosition2 : double;
begin
...
function KReaperExt.getCursorPosition : double;
begin
...
function KReaperExt.getPlayState : longint;
begin
...
procedure KReaperExt.setEditCurPos(time:double; moveview,seekplay:boolean);
begin
...
function KReaperExt.getsetRepeat(parm:longint) : longint;
begin
...
procedure KReaperExt.getProjectPath(buf:pchar; bufsiz:longint);
begin
...
procedure KReaperExt.onPlayButton;
begin
...
procedure KReaperExt.onStopButton;
begin
...
procedure KReaperExt.onPauseButton;
begin
...
function KReaperExt.isInRealTimeAudio : longint;
begin
...
function KReaperExt.audioIsRunning : longint;
begin
